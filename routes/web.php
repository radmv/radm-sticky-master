...
Route::middleware('auth')->group(function () {
    Route::middleware(HasRoleAdminMiddleware::class)->group(function () {
        Route::get('store/list', [Controllers\StoreController::class, 'list'])->name('stores.list');
        Route::put('store/approve/{store}', [Controllers\StoreController::class, 'approve'])->name('stores.approve');
    });
...
Route::get('store/{store:slug}', [Controllers\StoreController::class, 'show'])->name('stores.show');
