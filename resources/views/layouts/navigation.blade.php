<nav x-data="{ open: false }" class="border-b border-zinc-800 bg-zinc-900">
            ...
            @auth
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button
                                class="inline-flex items-center px-3 py-2 text-sm font-medium leading-4 text-white transition duration-150 ease-in-out border rounded-md border-zinc-700 bg-zinc-800 hover:text-white focus:outline-none">
